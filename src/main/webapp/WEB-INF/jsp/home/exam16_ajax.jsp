				...
				function fun1() {
					$.ajax({
						...
						success:  function(data, textStatus, jqXHR ){
								console.log("비동기 결과가 왔음");
								$("#div1").html(data);								//append(data)로 하면 계속 누적 추가될 수 있음
						}
					});
					console.log("나 먼저 실행한다~~~")
				}
						...
						success: function(data) {
							if (data.result == "success"){
								...
								$("#logoutDiv").show();
									...
									$("#errorMid").html(" *** 해당 ID가 존재하지 않습니다. *** ");
							}	else if (data.result == "wrongMpassword") {
									$("#errorMpassword").html(" *** 비밀번호가 잘못되었습니다. *** ");
							}
						}
					}); 
				}
	...
	<body>
		...
		<div style="margin-bottom: 20px; padding: 10px; border-top: 1px solid black">
				...
				<div id="div2" style="margin: 10px; padding: 10px; border: 1px solid black ">
						<img id="img2" width="400px" height="400px" src= "${pageContext.request.contextPath}/resource/img/milk5.jpg"/>
				</div>
		</div>
		...
		<div style="margin-bottom: 20px; padding: 10px; border-top: 1px solid black">
				<div id="div3" style="margin: 10px; padding: 10px; border: 1px solid black ">
						<form id="loginForm" name="loginForm">
								...
								Password: <input id="mpassword" name="mpassword" type="password"/><span id="errorMpassword" style="color:red;"></span><br/>
